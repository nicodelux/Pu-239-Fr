    ...
    getUserNodeStringItems: function (encodedUserName, userID, isInline) {
        ...
        if (encodedUserName !== this.encodedUserName) {
            menu = '<li><a href="javascript:ajaxChat.insertMessageWrapper(\'/msg '
                ...
                + encodedUserName
                + '\');" title="Ouvrir un tchat privé entre vous 2.">'
                + this.lang['userMenuOpenPrivateChannel']
                + '</a></li>'
                + '<li><a href="javascript:ajaxChat.sendMessageWrapper(\'/query\');" title="Fermer le tchat privé.">'
            ...
            menu = '<li class="disc"><a target="_blank" href="../pm_system.php" title="How many unread site PMs you have.">'
                + 'MP non lu (<span id="pmcount">0</span>)</a></li>'
                + '<li><a href="javascript:ajaxChat.sendMessageWrapper(\'/who\');">'
                + this.lang['userMenuWho']
                + '</a></li>'
                + '<li class="circle"><a href="#" onclick="return ajaxChat.showHide(\'statslist\');" title="Cliquez pour afficher le menu">Menu statistiques</a><ul style="display: none;" id="statslist">'
                + '<li class="disc"><a href="javascript:ajaxChat.sendMessageWrapper(\'/stats '
                + encodedUserName
                + '\');" title="Afficher vos statistique en message privé sur le tchat">Vos statistiques'
                + '</a></li>'
                + '<li class="disc"><a href="javascript:ajaxChat.sendMessageWrapper(\'/casino \');" title="Affiche les statistique du casino et blackjack.">'
                + 'Statistique des jeux'
                + '</a></li>'
                + '<li class="disc"><a href="' + window.location.protocol + '//' + window.location.host + '/hnrs.php" target="_blank">Hit and Runs</a></li>'
                + '<li class="disc"><a href="' + window.location.protocol + '//' + window.location.host + '/port_check.php" target="_blank">Port connectable</a></li>'
                + '<li class="disc"><a href="javascript:ajaxChat.sendMessageWrapper(\'/mentions \');" title="Montre les derniers 25 message ou vous êtes cité.">'
                + 'Mentionner'
                + '</a></li>'
                + '</ul></li>'
                + '<li><a href="javascript:ajaxChat.sendMessageWrapper(\'/ignore\');">'
            ...
            if (this.userRole >= UC_POWER_USER) {
                ...
                if (this.userRole >= UC_STAFF) {
                    menu += '<li><a href="javascript:ajaxChat.sendMessageWrapper(\'/bans\');">'
                        ...
                        + '</a></li>'
                        + '<li class="disc"><a href="javascript:ajaxChat.insertMessageWrapper(\'/announce \');" title="Faire une annonce qui sera affiché sur le tchat et envoyé en MP.">'
                        + 'Faire une annonce'
                        + '</a></li>'
                        + '<li class="disc"><a href="javascript:ajaxChat.insertMessageWrapper(\'/takeover \');" title="Parler au nom de System.">'
                        + 'System'
                        + '</a></li>';
                }
                if (this.userRole >= UC_ADMINISTRATOR) {
                    menu += '<li><a href="../ajaxchat.php?view=logs" title="Voir tout les messages.">'
                        + 'Historique'
                        + '</a></li>';
                }
            }
