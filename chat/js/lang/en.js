...
var ajaxChatLang = {
    ...
    roll: '%s jete %s et reçoit %s.',
    nick: '%s is now known as %s.',
    toggleUserMenu: 'Toggle user menu for %s',
    userMenuLogout: 'Logout',
    userMenuWho: 'Liste des membres en ligne',
    userMenuList: 'Liste des cannaux disponibles',
    userMenuAction: 'Describe action',
    userMenuRoll: 'Jeter les dés',
    userMenuNick: 'Changer de pseudo',
    userMenuEnterPrivateRoom: 'Créer un canal privé',
    userMenuSendPrivateMessage: 'Envoyer un MP',
    userMenuDescribe: 'Send private action',
    userMenuOpenPrivateChannel: 'Ovrir un canal privé',
    userMenuClosePrivateChannel: 'Fermer le canal privé',
    userMenuInvite: 'Inviter',
    userMenuUninvite: 'Supprimer invitation',
    userMenuIgnore: 'Ignorer/Accepter',
    userMenuIgnoreList: 'Liste des membres ignorés',
    userMenuWhereis: 'Display channel',
    userMenuKick: 'Kick/Ban',
    userMenuBans: 'Liste des membres banis',
    userMenuWhois: 'Afficher IP',
