...
$main_div .= "
                                        ...
                                        <div class='has-text-centered'>
                                            <label for='checkAll'>
                                                <input type='checkbox' id='checkAll' /><span> Sélectionnez toutes les catégories</span>
                                            </label>
                                        </div>";
...
$vip_box = "
                    <select name='vip' class='w-100'>
                        <option value='0'>Torrents VIP inclus</option>
                        <option value='1'" . ($vip == 1 ? ' selected' : '') . ">Torrents VIP non inclus</option>
                        <option value='2'" . ($vip == 2 ? ' selected' : '') . '>VIP Torrents seulement</option>
                    </select>';
...
$only_free_box = "
                    <select name='only_free' class='w-100'>
                        <option value='0'>Inclure les torrents non gratuit</option>
                        <option value='1'" . ($only_free == 1 ? ' selected' : '') . '>Seulement torrents gratuits</option>
                    </select>';
