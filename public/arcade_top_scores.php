...
$HTMLOUT = "
        <center><h1>{$site_config['site_name']} Arcade - Meilleur scores!</h1>
        <div class='bottom10'>
            <div>Battre un records vous raporte {$site_config['top_score_points']} €</div>
            <div class='level-center top10'>
                <a class='altlink' href='{$site_config['baseurl']}/arcade.php'>Retour aux jeux d'arcade</a>
            </div>
        </div>";
        ...
        <div class="bg-02 has-text-centered padtop10 round5">
            ...
            <table class="table table-bordered table-striped top20 bottom20">
                <thead>
                    <tr>
                        <th colspan="2">
                            <div class="size_4 has-text-centered">So far, you have played a total of ' . number_format($member_totals['count']) . ' games, scoring ' . number_format($member_totals['score']) . ' points in total!</div>
                        </th>
                    </tr>
                    <tr>
                        <th class="w-50">
